import {
  ...
  export const requestBooking = catchAsyncErrors(async (req, res, next) => {
    const { providerId, categoryId, address, scheduledDate, notes } = req.body;
    ...
    const insertId = await insertBooking(customerId, providerId, categoryId, address, scheduledDate, notes);
